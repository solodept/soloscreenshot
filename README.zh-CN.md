...
[![macOS](https://img.shields.io/badge/macOS-Signed%20%26%20Notarized-brightgreen.svg)](#)
...
SoloScreenshot 可免费试用。终身 Pro 版可解锁所有页面、商店尺寸和已配置语言的批量导出能力。
...
| 操作系统 | 下载链接 | 说明 |
| :--- | :--- | :--- |
| **macOS** | [下载 macOS DMG](https://github.com/solodept/soloscreenshot/releases) | 已完成代码签名和公证的 DMG 安装包 |
...
macOS 版本已完成 Apple 代码签名和公证。通常情况下，从官方网站或 GitHub Releases 下载 DMG 后，可以直接安装并打开 SoloScreenshot。

如果 macOS 因为应用来自 Mac App Store 之外而要求再次确认：

1. 确认安装包来自 [GitHub Releases](https://github.com/solodept/soloscreenshot/releases) 的最新版本。
2. 将 `SoloScreenshot.app` 拖入 `应用程序 (Applications)` 文件夹。
3. 打开 **系统设置 > 隐私与安全性**，如看到 SoloScreenshot 的提示，点击 **仍要打开**。
